...
typedef void (* rayo_call_component_fn)(switch_core_session_t *session, struct rayo_call *call, iks *iq);
extern void rayo_call_component_add(const char *command, rayo_call_component_fn start, rayo_call_component_fn stop);
...
extern void rayo_call_component_send_ref(struct rayo_call *call, iks *iq, const char *ref);
extern void rayo_call_component_send_iq_error(struct rayo_call *call, iks *iq, const char *error_name, const char *error_type);
extern char *rayo_call_component_jid_create(struct rayo_call *call, char *component_ref);
extern char *rayo_call_component_ref_create(struct rayo_call *call, const char *type);
